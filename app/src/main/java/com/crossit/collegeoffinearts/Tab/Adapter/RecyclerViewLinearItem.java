...
public class RecyclerViewLinearItem extends RecyclerView.Adapter<RecyclerViewLinearItem.ViewHolder> {

    private LayoutInflater mInflater;
    ArrayList<Integer> resId;
    ArrayList<String> txt;
    public RecyclerViewLinearItem(Context context, ArrayList<Integer> resId, ArrayList<String> txt)
    {
    ...
    public int getItemCount() {
        return (resId.size()>txt.size()?resId.size():txt.size());
    }
